import { Bell, CirclePlus, Cog, MessageCircleMore, Moon, Search, ShoppingBag, SlidersHorizontal, UserCircle2, Users } from "lucide-react";
...
export function CoachShell({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0a0a0f] text-white">
      <div className="absolute inset-0 -z-[1] bg-[radial-gradient(circle_at_top,rgba(34,66,52,0.08),transparent_16%),linear-gradient(180deg,#0a0a0f,#0c0c11)]" />

      <div className="mx-auto flex h-screen w-full max-w-[1680px] px-5 py-8">
        <aside className="hidden w-[248px] shrink-0 lg:block">
          <div className="flex h-full flex-col rounded-[26px] border border-[#232329] bg-[#121218] px-5 py-6 shadow-[0_35px_90px_rgba(0,0,0,0.35)]">
            ...
            <div className="mt-8">
              <p className="px-1 text-[10px] uppercase tracking-[0.32em] text-white/28">Main Menu</p>
            ...
            <a href="/coach/onboarding" className="mt-auto block rounded-[24px] border border-[#282830] bg-[#15151b] p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[11px] uppercase tracking-[0.26em] text-white/28">New Client</p>
                  <h3 className="mt-2 text-base font-semibold leading-tight">Onboard a new Client</h3>
                </div>
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#17171d] text-white">
                  <CirclePlus className="h-5 w-5" />
                </div>
              </div>
              <p className="mt-3 text-[13px] leading-6 text-white/48">Start a fresh onboarding flow and send their access instantly.</p>
            </a>
          </div>
        </aside>
